<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="model.Companies,model.Employees,model.Memos,java.util.List,model.MemoPost,model.ModelError" %>
<%
...
<% if ("memoPost".equals(error.getErrorCode()) || "memos".equals(error.getErrorCode())) { %>
